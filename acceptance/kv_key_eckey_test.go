		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("az-confidential_keyvault_key.ec_key", "key_version"),
					resource.TestCheckResourceAttrSet("az-confidential_keyvault_key.ec_key", "public_key_pem"),
					resource.TestCheckResourceAttr("az-confidential_keyvault_key.ec_key", "enabled", "true"),
				),
			},
		},
	})
