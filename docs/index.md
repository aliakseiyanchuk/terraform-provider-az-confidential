...
- `file_hash_tracker` (Attributes) OAEP Label to use during the encrypted data unwrapping (see [below for nested schema](#nestedatt--file_hash_tracker))
...
- `file_name` (String) File on a local machine where to track created secrets
